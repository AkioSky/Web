...
class JFormFieldVersionCheck extends JFormField {
	...
	public function getInput()	{
		...
		if ($this->element['pluginfolder']->data() && $this->element['pluginname']->data()) {
			$pluginfolder = $this->element['pluginfolder']->data();
			$pluginname = $this->element['pluginname']->data();
			$xml = JFactory::getXML(JPATH_SITE.DS.'plugins'.DS.$pluginfolder.DS.$pluginname.DS.$pluginname.'.xml');
		} else {
